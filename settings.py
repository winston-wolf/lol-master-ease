...
API_URL_MATCH_LIST = 'https://{region}.api.pvp.net/api/lol/{region}/v2.2/matchlist/by-summoner/{summonerId}?rankedQueues=RANKED_SOLO_5x5&championIds={championIds}&beginIndex={beginIndex}&endIndex={endIndex}&api_key={apiKey}'
