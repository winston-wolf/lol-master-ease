...
App.MatchesController = Ember.ArrayController.extend({
    ...
    actions: {
        ...
        filter_champion: function(champion) {
            console.log('filter by champ', champion);
        }
    },
    fetch_match_stats: function(match) {
        var self = this,
            ...
            champion_id = this.get('champion_id'),
...
App.MatchesRoute = Ember.Route.extend({
    ...
    model: function(params) {
        ...
        summonerSearchController.set('champion_id', params.champion_id);
